export default function Editor() {
  return (
    <div className="h-full flex flex-col">
      <div className="flex justify-between items-center bg-200 font-medium text-500 tracking-[2px] px-4 py-3 text-sm">
        MARKDOWN
      ...
      <div className="flex-1 block overflow-y-scroll m-4">
        <textarea className="w-full min-h-full bg-100 outline-none dark:bg-900" />
      </div>
    </div>
  );
}
